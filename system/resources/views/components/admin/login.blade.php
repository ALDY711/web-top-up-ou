    ...
    <body style="color: rgb(230, 230, 230);">
        ...
        <div class="justify-between pl-4 pr-2 md:px-12 lg:px-16 py-10 flex flex-col min-h-screen max-h-screen overflow-y-scroll overflow-x-hidden css-1jh570t">
           <a href="{{ route('home') }}">
            <img
                alt="logo"
                srcset="{{ isset($logoheader->path) ? $logoheader->path : "" }}"
                width="150"
                height="150"
                decoding="async"
                data-nimg="1"
            ...
            <div class="z-10">
                ...
                <div class="w-full md:w-1/2 lg:w-[35%] mt-[30px]">
                    ...
                    <form role="form" action="{{ route('post.login') }}" method="POST">
                        ...
                        <div class="g-recaptcha" id="g-recaptcha" name="grecaptcha" data-sitekey="{{ !$config ? '' : $config->captcha_sitekey }}"></div>
                        <button
            ...
            <p class="mt-10 lg:text-start md:text-start text-center">© 2023 {{ !$config ? '' : $config->web_title }}. Semua Hak Cipta</p>
        </div>
    </body>
