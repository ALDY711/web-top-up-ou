          ...
          <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-lg-10">
                        <input type="file" class="form-control" name="product_logo"> @error('product_logo') <div class="invalid-feedback">
                            {{ $message }}
                        </div> @enderror
                    </div>
                </div>
                <hr />
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-lg-5">
                                    <input type="number" class="form-control @error('harga_flash_salee') is-invalid @enderror" value="{{ old('harga_flash_salee') }}" name="harga_flash_salee"> @error('harga_flash_salee') <div class="invalid-feedback">
                                        {{ $message }}
                                    </div> @enderror
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-lg-5">
                                    <input type="date" class="form-control @error('expired_flash_sale') is-invalid @enderror" value="{{ old('expired_flash_sale') }}" name="expired_flash_sale"> @error('expired_flash_sale') <div class="invalid-feedback">
                                        {{ $message }}
                                    </div> @enderror
                                </div>
                            </div>
                    ...
                    <table class="table m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Rp. <font class="text-danger"><del>{{ number_format($data->harga_flash_salee, 0, '.', ',') }}</del></font></td>
