...
.list-group-item:last-child {
    ...
    .games-thumbnail {
        ...
        border-radius:20px !important background:url('{{ $kategori->event }}');
...
.games-bg {
   ...
   .bg-emerald-500	{
    ...
    .from-primary-500 {
        --tw-gradient-from: hsl(var(--primary-500));
        --tw-gradient-to: hsl(var(--primary-500)/0);
        --tw-gradient-stops: var(--tw-gradient-from),var(--tw-gradient-to);
    }
    ...
    .to-primary-200 {
        --tw-gradient-to: hsl(var(--primary-200));
    }
    ...
    <main class="relative">
        <div class="relative h-80 mt-4">
            <div class="absolute inset-0">
                <img class="hidden h-full w-full object-cover inline-block" src="{{ $kategori->bannerlayanan  }}" alt=""/>
                <div class="absolute inset-0 mix-blend-multiply" aria-hidden="true"></div>
            </div>
<div class="relative mx-auto max-w-7xl py-16 px-2 sm:py-32 sm:px-6 lg:px-8"></div>
    <div class="absolute inset-0 -z-11" >
        <div class="area">
          <ul style="background: hsl(var(--secondary-700)); !important" class="circles ">
          <li></li>
          <li></li>
          <li></li>
          <li></li>
        ...
        <section class="bg-nvd">
            <div class="relative mx-auto max-w-7xl pb-1 ">
                <div class="shadow-detail-card px-3 pb-3 sm:py-8 md:px-6">
                    <div class="container relative flex flex-row items-center space-x-4 pb-3 md:items-center">
                        <div class="product-thumbnail-container -mt-8 sm:-mt-20 sm:rounded-3xl sm:bg-[#952624] sm:p-2 ">
                            <img width="300" height="300" src="{{ $kategori->thumbnail }}" alt="{{ $kategori->nama }}"
                                class="h-28 w-32 rounded-2xl object-cover md:h-[170px] md:w-[170px]" />
                        </div>
                        <div class="flex-1 space-y-0.5 pt-6 sm:mt-3 sm:space-y-2 md:mt-6">
                            <h1 class="flex items-center font-extrabold text-white sm:text-3xl">{{ $kategori->nama }}
                            </h1>
                            <div class="flex flex-wrap items-center gap-2 gap-x-4 pt-3">
                                
                                @if($kategori->kode == "mobile-legends"||$kategori->kode == "free-fire" ||$kategori->kode == "mobile-legends-a" ||$kategori->kode == "genshin-impact" ||$kategori->kode == "pubg-mobile" ||$kategori->kode == "freefire-max")
                                    <div class="inline-flex items-center space-x-2 text-xs md:text-sm">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="h-3 w-3 text-yellow-400"><path d="M11.983 1.907a.75.75 0 00-1.292-.657l-8.5 9.5A.75.75 0 002.75 12h6.572l-1.305 6.093a.75.75 0 001.292.657l8.5-9.5A.75.75 0 0017.25 8h-6.572l1.305-6.093z"></path></svg>
                                    <span class="font-semibold">Proses Cepat</span></div>
                                    <div class="inline-flex items-center space-x-2 text-xs md:text-sm"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="h-3 w-3 text-sky-300"><path fill-rule="evenodd" d="M10 2c-2.236 0-4.43.18-6.57.524C1.993 2.755 1 4.014 1 5.426v5.148c0 1.413.993 2.67 2.43 2.902.848.137 1.705.248 2.57.331v3.443a.75.75 0 001.28.53l3.58-3.579a.78.78 0 01.527-.224 41.202 41.202 0 005.183-.5c1.437-.232 2.43-1.49 2.43-2.903V5.426c0-1.413-.993-2.67-2.43-2.902A41.289 41.289 0 0010 2zm0 7a1 1 0 100-2 1 1 0 000 2zM8 8a1 1 0 11-2 0 1 1 0 012 0zm5 1a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"></path></svg>
                                    <span class="font-semibold">Layanan Chat 24/7</span></div>
                                    <div class="inline-flex items-center space-x-2 text-xs md:text-sm"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="h-3 w-3 text-green-400"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-6.5 6.326a6.52 6.52 0 01-1.5.174 6.487 6.487 0 01-5.011-2.36l.49-.98a.423.423 0 01.614-.164l.294.196a.992.992 0 001.491-1.139l-.197-.593a.252.252 0 01.126-.304l1.973-.987a.938.938 0 00.361-1.359.375.375 0 01.239-.576l.125-.025A2.421 2.421 0 0012.327 6.6l.05-.149a1 1 0 00-.242-1.023l-1.489-1.489a.5.5 0 01-.146-.353v-.067a6.5 6.5 0 015.392 9.23 1.398 1.398 0 00-.68-.244l-.566-.566a1.5 1.5 0 00-1.06-.439h-.172a1.5 1.5 0 00-1.06.44l-.593.592a.501.501 0 01-.13.093l-1.578.79a1 1 0 00-.553.894v.191a1 1 0 001 1h.5a.5.5 0 01.5.5v.326z" clip-rule="evenodd"></path></svg>
                                    <span class="font-semibold">Instant</span></div>
                                     @elseif($kategori->kode == "Youtube-Premium" ||$kategori->kode == "Disney-Hotstar" || $kategori->kode == "Netflix-Premium" || $kategori->kode == "Spotify-Premium" || $kategori->kode == "Canva-Premium" || $kategori->kode == "Amazone-Prime-Premium")
                                    <div class="inline-flex items-center space-x-2 text-xs md:text-sm">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="h-3 w-3 text-yellow-400"><path d="M11.983 1.907a.75.75 0 00-1.292-.657l-8.5 9.5A.75.75 0 002.75 12h6.572l-1.305 6.093a.75.75 0 001.292.657l8.5-9.5A.75.75 0 0017.25 8h-6.572l1.305-6.093z"></path></svg>
                                    <span class="font-semibold">Proses 1/24 Jam</span></div>
                                    <div class="inline-flex items-center space-x-2 text-xs md:text-sm"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="h-3 w-3 text-sky-300"><path fill-rule="evenodd" d="M10 2c-2.236 0-4.43.18-6.57.524C1.993 2.755 1 4.014 1 5.426v5.148c0 1.413.993 2.67 2.43 2.902.848.137 1.705.248 2.57.331v3.443a.75.75 0 001.28.53l3.58-3.579a.78.78 0 01.527-.224 41.202 41.202 0 005.183-.5c1.437-.232 2.43-1.49 2.43-2.903V5.426c0-1.413-.993-2.67-2.43-2.902A41.289 41.289 0 0010 2zm0 7a1 1 0 100-2 1 1 0 000 2zM8 8a1 1 0 11-2 0 1 1 0 012 0zm5 1a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"></path></svg>
                                    <span class="font-semibold">Layanan Chat 24/7</span></div>
                ...
                <div class="sticky top-24 flex flex-col space-y-8">
                    <div class="card">
                     <!-- <div class="flex border-b border-murky-900">
                        ...
                        <div class="prose prose-sm px-4 py-2 pb-8 text-xs text-white/70 sm:px-6">
                            <div>
                                <br>Cara Order :</br>
                                                                        <ol>
                                                                        ...
                                                                        @elseif($kategori->kode == "apex-legend-mobile")
                                                                        <li>Masukkan ID</li>
                                                                        ...
                                                                        @elseif($kategori->kode == "league-of-legends")
                                                                        ...
                                                                        @elseif($kategori->kode == "tom-and-jerry")
                                                                        <li>Masukkan ID</li>
                                                                        <li>Pilih Nominal Diamond</li>
                                                                        <li>Pilih Metode Pembayaran</li>
                                                                        <li>Masukkan Nomor WhatsApp</li>
                                                                        ...
                                                                        @elseif($kategori->kode == "mu-origin-3")
                                                                        <li>Masukkan ID</li>
                                                                        ...
                                                                        @elseif($kategori->kode == "one-punch-man")
                                                                        <li>Masukkan ID dan Server</li>
                                                                        ...
                                                                        @elseif($kategori->kode == "omega-legend")
                                                                        <li>Masukkan ID</li>
                                                                        ...
                                                                        @elseif($kategori->kode == "mangatoon")
                                                                        <li>Masukkan ID</li>
                                                                        ...
                                                                        @elseif($kategori->kode == "Youtube-Premium" ||$kategori->kode == "Disney-Hotstar")
                        ...
                        <li>Tulis Nomor WhatsApp Sesuai Petunjuk! </li>
                        <li>Klik Beli &amp; lakukan Pembayaran </li>
                         @elseif($kategori->kode == "Voucher-Playstation" ||$kategori->kode == "Voucher-Roblox"||$kategori->kode == "Voucher-Shell"||$kategori->kode == "Voucher-Steam"||$kategori->kode == "Voucher-Valorant"||$kategori->kode == "Voucher-Razer")
                        <li>Masukkan Nomor Whatsapp</li>
                        <li>Pilih Nominal </li>
                        <li>Pilih Metode Pembayaran </li>
                        <li>Tulis Nomor WhatsApp Sesuai Petunjuk </li>
                        ...
                        @elseif($kategori->kode == "Jasa-Joki")
                        <p><strong>Joki Rank</strong> Mobile Legends dari <i>{{ ENV('APP_NAME') }}</i>: Solusi Cepat Naik Rank !</p>
...
<ol>
	...
	<li>Masukkan Jumlah Order Sesuai Tujuan Rank (Pastikan jumlah order sesuai dengan rank yang Anda inginkan dan sesuai dengan S&K <i>{{ ENV('APP_NAME') }})</i></li>
...
<p><i>{{ ENV('APP_NAME') }}</i> Sahabat Para Gamers!</p>
                                ...
                                <p>
                                    ...
                                    {!! htmlspecialchars_decode($kategori->ket_layanan) !!}
            ...
            <ul class="col-span-3 flex flex-col space-y-8 md:col-span-2">
                    ...
                    <div class="card border-0 mb-0 shadow-form">
                        <div class="">
                            <div class="flex border-b border-murky-600">
                                <div class="flex items-center justify-center rounded-tl-xl bg-gradient-to-b from-primary-500 to-primary-200 px-4 py-2 text-xl font-semibold">1</div>
                                <h4 class="card-titel mt-2 ms-2 flex items-center font-extrabold leading-6 md:text-xl" style="color: rgb(234 234 234);">
                                    Masukkan Data</h4>
                                <div class="cursor-pointer">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="2" stroke="currentColor" data-bs-toggle="modal"
                                        data-bs-target="#petunjukModal" aria-hidden="true"
                                        class="h-5 w-5 text-gray-600 ms-2 mt-2" style="cursor:pointer;">
                        ...
                        <div class="px-1">
                            ...
                            <div class="card-body">
                                ...
                                <div id="userData">
                                    ...
                                    @if($kategori->server_id && $kategori->kode != "life-after" &&
                                    ...
                                    <div class="grid gap-2 grid-cols-2 sm:grid-cols-2 lg:grid-cols-2">
                                        <div class="w-full">
                                            <div class="relative rounded-sm text-black shadow-sm">
                                                <input
                                                    class="form-floating bg-gray-300 focus:!bg-white block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border-[#2D2EAD] focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]"
                                        ...
                                        <div class="w-full">
                                            <div class="relative rounded-md text-black shadow-sm">
                                                <input
                                                    class="block w-full bg-gray-300 focus:!bg-white rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border-[#2D2EAD] focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]"
                                    ...
                                    <div class="grid gap-2 grid-cols-2 sm:grid-cols-2 lg:grid-cols-2">
                                        ...
                                        <div class="w-full">
                                            ...
                                            <div class="relative rounded-md text-black shadow-sm">
                                                ...
                                                <input
                                                    class="block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border-[#2D2EAD] focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]"
                                        ...
                                        <div class="w-full">
                                            ...
                                            <div class="relative rounded-md text-black shadow-sm">
                                                ...
                                                <select
                                                    class="block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border-indigo-700 focus:ring focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem] appearance-none"
                                   ...
                                   @elseif($kategori->kode == "ace-racer")
                                    ...
                                    <div class="grid gap-2 grid-cols-1">
                                        <div class="w-full">
                                            <div class="relative rounded-md text-black shadow-sm">
                                                <input class="block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border-[#2D2EAD] focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]"
                                    ...
                                    <div class="grid gap-2 grid-cols-1">
                                        <div class="w-full">
                                            <div class="relative text-black shadow-sm">
                                                <input class="block rounded-md w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border-[#2D2EAD] focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]"
                                                    name="userId" id="user_id" placeholder="Masukkan Nomor HP" type="number" value="" required />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border-[#2D2EAD] focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]" placeholder="Masukkan Email" type="text"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-3 text-black">
                                            <input class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border-[#2D2EAD] focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]" placeholder="Masukkan Request Profile + PIN"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-3">
                                            <input class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border-[#2D2EAD] focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]" placeholder="Masukkan Nama Profile Spotify"
                                                type="text" name="zone" id="zone">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3 text-black">
                                          <input class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem] bg-gray-300 focus:!bg-white" placeholder="Masukkan Email +( Password Khusus Email Sendiri )" type="text"
                                                name="user_id" id="user_id" required>
                                        </div>
                                    </div>
                                   ...
                                   @elseif($kategori->kode == "Voucher-Shell")
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3 text-black">
                                    ...
                                    @elseif($kategori->kode == "Voucher-Steam")
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3 text-black">
                                          <input class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]" placeholder="Masukan Nomor Whatsapp." type="text"
                                                name="user_id" id="user_id" required>
                                    ...
                                    <p class="mt-2 text-sm" style="font-size: 12px; color: rgb(203, 203, 203);">Masukan nomor Handphone. Kode voucher otomatis terkirim melalui Riwayat Pesanan.</p>
                                    @elseif($kategori->kode == "Voucher-Playstation")
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3 text-black">
                                          <input class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]" placeholder="Masukan Nomor Whatsapp." type="text"
                                                name="user_id" id="user_id" required>
                                    ...
                                    <p class="mt-2 text-sm" style="font-size: 12px; color: rgb(203, 203, 203);">Masukan nomor Handphone. Kode voucher otomatis terkirim melalui Riwayat Pesanan.</p>
                                    @elseif($kategori->kode == "Voucher-Razer")
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3 text-black">
                                          <input class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]" placeholder="Masukan Nomor Whatsapp." type="text"
                                                name="user_id" id="user_id" required>
                                    ...
                                    <p class="mt-2 text-sm" style="font-size: 12px; color: rgb(203, 203, 203);">Masukan nomor Handphone. Kode voucher otomatis terkirim melalui Riwayat Pesanan.</p>
                                    @elseif($kategori->kode == "Voucher-Roblox")
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3 text-black">
                                          <input class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]" placeholder="Masukan Nomor Whatsapp." type="text"
                                                name="user_id" id="user_id" required>
                                    ...
                                    <p class="mt-2 text-sm" style="font-size: 12px; color: rgb(203, 203, 203);">Masukan nomor Handphone. Kode voucher otomatis terkirim melalui Riwayat Pesanan.</p>
                                    @elseif($kategori->kode == "Voucher-Valorant")
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3 text-black">
                                          <input class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]" placeholder="Masukan Nomor Whatsapp." type="text"
                                                name="user_id" id="user_id" required>
                                    ...
                                    <div>
                                        <div class="grid gap-2 grid-cols-2 sm:grid-cols-2 lg:grid-cols-2">
                                            <div class="w-full">
                                                <div class="form-group mb-3 text-black">
                                                    <input class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem] bg-gray-300 focus:!bg-white" placeholder="Masukkan Email"
                                                        type="text" name="email_joki" id="email_joki"/>
                                                </div>
                                            </div>
                                            <div class="w-full">
                                                <div class="form-group mb-3 text-black">
                                                    <input class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem] bg-gray-300 focus:!bg-white" placeholder="Masukkan Password"
                                            ...
                                            <div class="w-full">
                                                <div class="form-group mb-3 text-black">
                                                    <input class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem] bg-gray-300 focus:!bg-white" placeholder="Minimal Request 3 Hero"
                                            ...
                                            <div class="w-full">
                                                <div class="form-group mb-3 text-black">
                                                    ...
                                                    <input class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem] bg-gray-300 focus:!bg-white" placeholder="Catatan Untuk Penjoki"
                                            ...
                                            <div class="w-full">
                                                <div class="form-group mb-3 text-black">
                                                    ...
                                                    <input class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem] bg-gray-300 focus:!bg-white" placeholder="NickName"
                                    ...
                                    <select class="form-select form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem] bg-gray-300 focus:!bg-white" placeholder="Login Via" id="loginvia_joki" name="loginvia_joki">
                                    ...
                                    <div class="grid gap-2 grid-cols-1">
                                        <div class="w-full">
                                            <div class="relative rounded-md text-black shadow-sm">
                                                <input
                                                    class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem] bg-gray-300 focus:!bg-white"
                                                    name="userId" id="user_id" placeholder="User ID" type="text"
                                                    value="" fdprocessedid="8qd1hx" />
                                            </div>
                                        </div>
                                    </div>
                                    <p class="mt-2 text-xs">Silahkan Masukkan User ID Anda.</p>
                                    @endif
                                </div>
                            </div>
                        </div>
                ...
                <div class="card rounded-xl ">
                    <div class="card border-0 mb-0 shadow-form">
                        <div class="">
                            <div class="flex border-b border-murky-600">
                                <div class="flex items-center justify-center rounded-tl-xl bg-gradient-to-b from-primary-500 to-primary-200 px-4 py-2 text-xl font-semibold">2</div>
                                <h4 class="card-title mt-2 ms-2 lex items-center  font-extrabold leading-6 md:text-xl" style="color: rgb(234 234 234);">Pilih Nominal</h4>
                            </div>
                        </div>
                    </div>
                    <div class="px-1">
                        <div class="card-body">
                            ...
                            <div id="tempatNominal" class="mb-4">
                                <h3 class="font-semibold ms-1">{{ $paket['nama'] }}s</h3>
                                <div class="row row-cols-2 mt-1">
                                    @foreach($paket['layanan'] as $nom)
                                    <div class="col-lg-4 px-2 mt-2">
                                        <div class="list-group shadow h-100 ">
                                            ...
                                            <label for="{{ $nom->id }}" class="list-group-item h-100 bg-gradient">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="row" id="bayar">
                                                            <div class="col hayutopup-prod selected-order ">{{ $nom->layanan}}</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col nominal-price text-white">
                                                                @if($nom->is_flash_sale == 1 && $nom->expired_flash_sale >= date('Y-m-d'))
                                                                        <span class="sale-price text-white"><i>Rp {{ number_format($nom->harga_flash_salee) }}</i></span>
                                                                        <br>
                                                                        <span class="regular-price ">Rp {{ number_format($nom->harga) }}</span>
                                                                        @else
                                                                        <span class="sale-price text-white">Rp {{ number_format($nom->harga) }}</span>
                                                                        @endif  
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3 col-1 m-auto">
                                                        <img src="{{ $nom->product_logo }}" class="patihiconurl">
                                                    </div>
                                                </div>
                                            </label>
                                        </div>
                ...
                <div class="card rounded-xl ">
                    <div class="card border-0 mb-0 shadow-form">
                       ...
                       <!-- <img alt="step-two" srcset="/assets/icons/step-two.svg 1x, /assets/icons/step-two.svg 2x" src="/assets/icons/step-two.svg" width="26" height="26" decoding="async" data-nimg="1"
                                    loading="lazy" style="color: transparent; margin-left:-15px;" /> -->
                                <h4 class="card-title mt-2 ms-2 flex items-center font-extrabold leading-6 md:text-xl" style="color: rgb(234 234 234);">Pilih Jumlah Order</h4>
                            </div>
                        </div>
                    </div>
                    <div class="px-1">
                        <div class="card-body">
                            <div id="tempatNominal" class="mb-4">
                                <div class="col-lg-6">
                                    <div class="form-group mb-3 text-black">
                                        <input class="form-floating block w-full rounded-md bg-gray-300 focus:!bg-white border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border-[#2D2EAD] focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]" placeholder="Minimal Order 5" type="text" name="jumlah_joki" id="jumlah_joki" value="1" />
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card rounded-xl" id="bayar">
                    ...
                    <div class="card border-0 mb-0 shadow-form">
                        ...
                        <div class="">
                            <div class="flex border-b border-murky-600">
                                <div class="flex items-center justify-center rounded-tl-xl bg-gradient-to-b from-primary-500 to-primary-200 px-4 py-2 text-xl font-semibold">3</div>
                                    ...
                                    <div class="area-list-payment-method">
                                        ...
                                        <div class="child-box payment-drawwer shadow">
                                            ...
                                            <div class="header short-payment-support-info-head"
                                                ...
                                                <div class="right glowing-text {{$p->code}} "></div>
                                                ...
                                                <div class="row row-cols-2 row-cols-md-3 p-1">
                                                    ...
                                                    <div class="col-lg-4 p-1">
                                                        ...
                                                        <div class="list-group1 h-100">
                                                            ...
                                                            <input type="radio" name="pembayaran" id="{{$p->code}}"
                                                                value="{{$p->code}}">
                ...
                <div class="card rounded-xl">
                    ...
                    <div class="card border-0 mb-0 shadow-form">
                        ...
                        <div class="">
                            <div class="flex border-b border-murky-600">
                                <div class="flex items-center justify-center rounded-tl-xl bg-gradient-to-b from-primary-500 to-primary-200 px-4 py-2 text-xl font-semibold">4</div>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <div class="relative rounded-md shadow-sm">
                                    ...
                                    <div class="relative w-full rounded-full">
                                        ...
                                        <input type="text"
                                            class="form-control text-dark z-20 block w-full rounded-l-md p-2.5 pl-10 text-sm uppercase text-black focus:outline-none focus:border-[#707feb] focus:ring-2 focus:ring-[#2D2EAD] bg-gray-300 focus:!bg-white"
                                            id="voucher" placeholder="Kode Voucher">

                                        <button type="button" id="check"
                                            class="absolute btn-voucher btn-primary relative top-0 -right-[3px] rounded-r-md py-2.5 px-3 text-sm font-medium"
                                            style="height:41px;">
                ...
                <div class="card rounded-xl">
                    ...
                    <div class="card border-0 mb-0 shadow-form">
                        ...
                        <div class="">
                            <div class="flex border-b border-murky-600">
                                <div class="flex items-center justify-center rounded-tl-xl bg-gradient-to-b from-primary-500 to-primary-200 px-4 py-2 text-xl font-semibold">5</div>
                    ...
                    <div class="px-2">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input class="form-control input-lg rounded-md bg-gray-300 focus:!bg-white py-2 my-2" placeholder="628xxxxx"
                            ...
                            <div class="mt-0 mr-3">
                                ...
                                <div class="g-recaptcha " id="g-recaptcha" name="grecaptcha"
                                    data-sitekey="{{ !$config ? '' : $config->captcha_sitekey }}"></div>
                            ...
                            <div class="row mt-0">
                                ...
                                <div class="col-lg-12 clearfix">
                                    ...
                                    <input type="hidden" name="ktg_tipe" id="ktg_tipe" value="{{$kategori->tipe}}">
                                </div>
                            </div>
                        </div>
                    </div>
               ...
               <button style="box-shadow: 0 .5rem 1rem rgba(255,255,255,.152)!important; background: rgb(184 15 15); color: rgb(255, 255, 255)"
                        class="melll mt-4 items-center justify-center rounded-md bg-primary-500 px-4 py-2 text-sm font-medium text-white duration-300 hover:bg-primary-400 disabled:cursor-not-allowed disabled:opacity-75 btn-order relative flex w-full gap-2 overflow-hidden"
                ...
                <div class="sticky inset-x-0 bottom-0 z-10 -mx-4 !mt-0 w-screen bg-gray-900 d-md-none">
                    <div class="container space-y-0 py-3">
                        ...
                        <div class="flex items-start justify-start space-x-4 py-1 md:hidden">
                            <div class="mb-2 aspect-square tihmel-5">
                                <img alt="icon" sizes="100vw" srcset="{{ $kategori->thumbnail }}"
                                    src="{{ $kategori->thumbnail }}" width="300" height="300" decoding="async"
                        ...
                        <div class="relative">
                            <button
                                ...
                                class="mt-4 inline-flex items-center justify-center rounded-md bg-primary-500 px-4 py-2 text-sm font-medium text-white duration-300 hover:bg-primary-400 disabled:cursor-not-allowed disabled:opacity-75 btn-order relative flex w-full gap-2 overflow-hidden"
