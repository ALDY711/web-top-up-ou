    ...
    <main class="relative">
        <div class="relative h-80 mt-4">
            <div class="absolute inset-0">
                <img class="hidden h-full w-full object-cover inline-block" src="{{ $kategori->bannerlayanan  }}"
                    alt="" />
...
<section style="background-color: #211E1C;" class="bg-nvd">
            ...
            <div class="container relative flex flex-row items-center space-x-4 pb-3 md:items-center">
                ...
                <div class="flex-1 space-y-0.5 pt-6 sm:mt-3 sm:space-y-2 md:mt-6">
                    ...
                    <div class="flex flex-wrap items-center gap-2 gap-x-4 pt-3">
                        ...
                        @if($kategori->kode == "mobile-legends"||$kategori->kode == "free-fire" ||$kategori->kode ==
                        "mobile-legends-a" ||$kategori->kode == "genshin-impact" ||$kategori->kode == "pubg-mobile"
                        ||$kategori->kode == "freefire-max")
                        <div class="inline-flex items-center space-x-2 text-xs md:text-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                aria-hidden="true" class="h-3 w-3 text-yellow-400">
                                <path
                            ...
                            <span class="font-semibold">Proses Cepat</span>
                        </div>
                        <div class="inline-flex items-center space-x-2 text-xs md:text-sm"><svg
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                aria-hidden="true" class="h-3 w-3 text-sky-300">
                                <path fill-rule="evenodd"
                                    d="M10 2c-2.236 0-4.43.18-6.57.524C1.993 2.755 1 4.014 1 5.426v5.148c0 1.413.993 2.67 2.43 2.902.848.137 1.705.248 2.57.331v3.443a.75.75 0 001.28.53l3.58-3.579a.78.78 0 01.527-.224 41.202 41.202 0 005.183-.5c1.437-.232 2.43-1.49 2.43-2.903V5.426c0-1.413-.993-2.67-2.43-2.902A41.289 41.289 0 0010 2zm0 7a1 1 0 100-2 1 1 0 000 2zM8 8a1 1 0 11-2 0 1 1 0 012 0zm5 1a1 1 0 100-2 1 1 0 000 2z"
                                    clip-rule="evenodd"></path>
                            </svg>
                            <span class="font-semibold">Layanan Chat 24/7</span>
                        </div>
                        <div class="inline-flex items-center space-x-2 text-xs md:text-sm"><svg
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                aria-hidden="true" class="h-3 w-3 text-green-400">
                                <path fill-rule="evenodd"
                        ...
                        $kategori->kode == "Netflix-Premium" || $kategori->kode == "Spotify-Premium" || $kategori->kode
                        == "Canva-Premium" || $kategori->kode == "Amazone-Prime-Premium")
                        <div class="inline-flex items-center space-x-2 text-xs md:text-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                aria-hidden="true" class="h-3 w-3 text-yellow-400">
                                <path
                            ...
                            <span class="font-semibold">Proses 1/24 Jam</span>
                        </div>
                        <div class="inline-flex items-center space-x-2 text-xs md:text-sm"><svg
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                aria-hidden="true" class="h-3 w-3 text-sky-300">
...
<div class="container px-3 grid grid-cols-3 gap-8 pb-8 pt-4">
    <div class="col-span-3 md:col-span-1">
        <div class="sticky top-24 flex flex-col space-y-8">
            <div style="background: #424242;" class="card">
                ...
                <div class="prose prose-sm px-4 py-2 pb-8 text-xs text-white/100 sm:px-6">
                    <div>
    ...
    <div class="col-span-3 flex flex-col space-y-8 md:col-span-2">
        <div class="card">
            <div style="background: #424242 !important;" class="card border-0 mb-0 shadow-form">
                <div class="">
                    <div class="flex border-b border-murky-600">
                        <div
                            class="flex items-center justify-center rounded-tl-xl bg-gradient-to-b from-primary-500 to-primary-200 px-4 py-2 text-xl font-semibold">
                            1</div>
                        ...
                        <div class="cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                stroke="currentColor" data-bs-toggle="modal" data-bs-target="#petunjukModal"
                                aria-hidden="true" class="h-5 w-5 text-gray-600 ms-2 mt-2" style="cursor:pointer;">
                ...
                <div class="px-1">
                    ...
                    <div class="card-body">
                        ...
                        <div id="userData">
                                ...
                                <div class="w-full">
                                    <div class="relative rounded-sm text-black shadow-sm">
                                        <input
                                            ...
                                            name="user_id" placeholder="User ID" type="text" value="" id="user_id" />
                                    </div>
                                </div>
                                <div class="w-full">
                                    <div class="relative rounded-md text-black shadow-sm">
                                        <input
                                            ...
                                            name="Server" placeholder="Server ID" type="text" value="" id="zone" />
                                    </div>
                                </div>
                            </div>

                            <p class="mt-2 text-xs">Silahkan Masukkan User ID &amp; Server Anda.</p>
                                ...
                                <div class="w-full">
                                    <div class="relative rounded-md text-black shadow-sm">
                                        <select
                                            ...
                                            name="zoneId" id="zone" placeholder="Pilih Server" fdprocessedid="n3x76">
                            ...
                            <option value="Asia-Pacific-Mars">Asia-Pacific-Mars</option></select>
                            </div>
                             </div>
                              </div>
                            <p class="mt-2 text-xs">Silahkan Masukkan User ID &amp; Server Anda.</p>
                                ...
                                <div class="w-full">
                                    <div class="relative rounded-md text-black shadow-sm">
                                        <select
                                            ...
                                            <option value="Asia - SHANGRI-LA [AS]"> Asia - SHANGRI-LA</option>
                            ...
                            <div class="grid gap-2 grid-cols-1">
                                <div class="w-full">
                                    <div class="relative rounded-md text-black shadow-sm">
                                        <input
                                            class="block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border-[#2D2EAD] focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]"
                                            name="userId" id="user_id" placeholder="Masukkan Nomor HP" type="number"
                                            value="" required />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid gap-2 grid-cols-1">
                                <div class="w-full">
                                    <div class="relative text-black shadow-sm">
                                        <input
                                            class="block rounded-md w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border-[#2D2EAD] focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]"
                                            name="userId" id="user_id" placeholder="Masukkan Nomor HP" type="number"
                                            value="" required />
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    <input
                                        class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border-[#2D2EAD] focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]"
                                        placeholder="Masukkan Email" type="text" name="user_id" id="user_id" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3 text-black">
                                    <input
                                        class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border-[#2D2EAD] focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]"
                                        placeholder="Masukkan Request Profile + PIN" type="text" name="zone" id="zone">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    <input
                                        class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border-[#2D2EAD] focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]"
                                        placeholder="Masukkan Nama Profile Spotify" type="text" name="zone" id="zone">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group mb-3 text-black">
                                    <input
                                        ...
                                        placeholder="Masukkan Email +( Password Khusus Email Sendiri )" type="text"
                            ...
                            <div class="col-lg-12">
                                <div class="form-group mb-3 text-black">
                                    <input
                                        class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]"
                                        placeholder="Masukan Nomor Whatsapp." type="text" name="user_id" id="user_id"
                                        required>
                                </div>
                            </div>
                            <p class="mt-2 text-sm" style="font-size: 12px; color: rgb(203, 203, 203);">Masukan nomor
                                Handphone. Kode voucher otomatis terkirim melalui Riwayat Pesanan.</p>
                                ...
                                <div class="grid gap-2 grid-cols-2 sm:grid-cols-2 lg:grid-cols-2">
                                    <div class="w-full">
                                        <div class="form-group mb-3 text-black">
                                            <input
                                                class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem] bg-gray-300 focus:!bg-white"
                                                placeholder="Masukkan Email" type="text" name="email_joki"
                                                id="email_joki" />
                                        </div>
                                    </div>
                                    <div class="w-full">
                                        <div class="form-group mb-3 text-black">
                                            <input
                                                class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem] bg-gray-300 focus:!bg-white"
                                                placeholder="Masukkan Password" type="text" name="password_joki"
                                                id="password_joki" />
                                        </div>
                                    </div>
                                    <div class="w-full">
                                        <div class="form-group mb-3 text-black">
                                            <input
                                                class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem] bg-gray-300 focus:!bg-white"
                                                placeholder="Minimal Request 3 Hero" type="text" name="request_joki"
                                                id="request_joki" />
                                        </div>
                                    </div>
                                    <div class="w-full">
                                        <div class="form-group mb-3 text-black">
                                            ...
                                            <input
                                                class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem] bg-gray-300 focus:!bg-white"
                                                placeholder="Catatan Untuk Penjoki" type="text" name="catatan_joki"
                                                id="catatan_joki" />
                                        </div>
                                    </div>
                                    <div class="w-full">
                                        <div class="form-group mb-3 text-black">
                                            ...
                                            <input
                                                class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem] bg-gray-300 focus:!bg-white"
                                                placeholder="NickName" type="text" name="nickname_joki"
                                                id="nickname_joki" />
                                        </div>
                                    </div>
                                    <div class="w-full">
                                        <div class="form-group mb-3 text-black">
                                            ...
                                            <select
                                                class="form-select form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem] bg-gray-300 focus:!bg-white"
                                                placeholder="Login Via" id="loginvia_joki" name="loginvia_joki">
                            ...
                            <div class="grid gap-2 grid-cols-1">
                                <div class="w-full">
                                    <div class="relative rounded-md text-black shadow-sm">
                                        <input
                                            class="form-floating block w-full rounded-md border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border: 1px solid #ced4da; focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem] bg-gray-300 focus:!bg-white"
                                            name="userId" id="user_id" placeholder="User ID" type="text" value=""
        ...
        <div style="background: #424242 !important;" class="card rounded-xl ">
            <div style="background: #424242 !important;" class="card border-0 mb-0 shadow-form">
                <div class="">
                    <div class="flex border-b border-murky-600">
                        <div
            ...
            <div style="background: #424242 !important;" class="px-1">
                <div style="background: #424242 !important;" class="card-body">
                        ...
                        <div class="row row-cols-2 mt-1">
                            ...
                            <div class="col-lg-4 px-2 mt-2">
                                <div class="list-group shadow h-100 ">
                                    <input type="radio" name="nominal" id="{{ $nom->id }}" value="{{ $nom->id }}"
                                        data-type="diamond">
                                    <label for="{{ $nom->id }}" class="list-group-item h-100 bg-gradient">
                                        <div class="row">
                                            <div class="col">
                                                <div class="row" id="bayar">
                                                    <div class="col hayutopup-prod selected-order ">{{ $nom->layanan}}
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col nominal-price text-white">
                                                        @if($nom->is_flash_sale == 1 && $nom->expired_flash_sale >=
                                                        date('Y-m-d'))
                                                        <span class="sale-price text-white"><i>Rp {{
                                                                number_format($nom->harga_flash_salee) }}</i></span>
                                                        <br>
                                                        <span class="regular-price ">Rp {{ number_format($nom->harga)
                                                            }}</span>
                                                        @else
                                                        <span class="sale-price text-white">Rp {{
            ...
            <div style="background: #424242 !important;" class="card border-0 mb-0 shadow-form">
                <div class="pl-2 py-1">
                    <div class="card-header flex align-items-center">
                        ...
                        <h4 class="card-title mt-2 ms-2 flex items-center font-extrabold leading-6 md:text-xl"
                ...
                <div class="card-body">
                    <div id="tempatNominal" class="mb-4">
                        <div class="col-lg-6">
                            <div class="form-group mb-3 text-black">
                                <input
                                    class="form-floating block w-full rounded-md bg-gray-300 focus:!bg-white border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border-[#2D2EAD] focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]"
                                    placeholder="Minimal Order 5" type="text" name="jumlah_joki" id="jumlah_joki"
                                    value="1" />
                            </div>
                        </div>
                    </div>
                    <p class="mt-2 text-sm" style="font-size: 12px; color: rgb(203, 203, 203);">Minimal Order adalah 5,
                        Jika Kurang Dari Minimal Order Maka Uang Akan Hangus</p>
                </div>
            </div>
        </div>
        @endif
       
        <div style="background: #424242 !important;" class="card rounded-xl" id="bayar">
            <div style="background: #424242 !important;" class="card border-0 mb-0 shadow-form">
                <div class="">
                    <div class="flex border-b border-murky-600">
                        <div
                        ...
                        <div class="col">
                            <div class="area-list-payment-method">
                                            ...
                                            <div class="col-lg-4 p-1">
                                                ...
                                                <div class="list-group1 h-100">
                                                    ...
                                                    <label for="{{$p->code}}" class="list-group-item h-100">
                                                        ...
                                                        <div class="info-bottom text-sm-left text-dark selected-order">
                                ...
                                <div class="child-box payment-drawwer shadow">
                                    ...
                                    <div class="header short-payment-support-info-head"
                                        onclick="openPaymentDrawer(this)" data-cf-modified-02988ce5d5669a4190e81d4d-="">
        ...
        <div style="background: #424242 !important;" class="card rounded-xl">
            ...
            <div class="px-2">
                <div class="card-body">
                    <div class="form-group mb-2">
                        <input class="form-control input-lg rounded-md bg-gray-300 focus:!bg-white py-2 my-2"
        ...
        <button
            style="box-shadow: 0 .5rem 1rem rgba(255,255,255,.152)!important; background-color: hsl(var(--primary-500)); color: rgb(255, 255, 255)"
                ...
                <div class="flex items-start justify-start space-x-4 py-1 md:hidden">
                    <div class="mb-2 aspect-square tihmel-5">
                        <img alt="icon" sizes="100vw" srcset="{{ $kategori->thumbnail }}"
                            src="{{ $kategori->thumbnail }}" width="300" height="300" decoding="async" data-nimg="1"
                            class="aspect-square tihmel-5 rounded-lg object-cover" loading="lazy"
