 ...
 <div class="container pt-5">
    <div class="row justify-content-center">
        <div class="col-sm-5 col-12 mb-5">
            <img src="<?php echo e(!$config ? '' : $config->web_logo); ?>" class="mlImg" alt="MobileLegends" width="140">
...
<?php echo $__env->make('../main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tridisos/topup.tridisosmed.com/system/resources/views/components/hitungpointzodiac.blade.php ENDPATH**/ ?>