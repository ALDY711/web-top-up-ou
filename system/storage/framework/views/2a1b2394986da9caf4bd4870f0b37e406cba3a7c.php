...
a {
  ...
  <!--Navbar -->
    <header class="mb-5">
    <nav class="fixed top-0 z-40 w-full border-b border-t bg-gray-600/75 border-transparent backdrop-blur " data-headlessui-state="open" data-aos="fade-down">
...
.offcanvas-backdrop.show {
  ...
  backdrop-filter: blur(8px);
    ...
    <div class="flex shrink-0 items-center px-4">
        <div class="offcanvas offcanvas-start offcanvas-backdrop.show bg-gray-700" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel"  visibility: visible;" aria-modal="true" role="dialog">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item hover:bg-btnPurple " href="<?php echo e(!$config ? '' : $config->wa_admin); ?>">Join Reseller</a>
    <a class="dropdown-item hover:bg-btnPurple " href="<?php echo e(!$config ? '' : $config->tele_admin); ?>">Join Komunitas</a>
  </div>
</div>
           <div class="dropdown">
  <a class="group flex items-center rounded-md p-2 w-90 text-base font-medium css-1tq05rq dropdown-toggle hover:bg-btnPurple"  id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="cursor:pointer;">
...
<!-- End Show Navbar--><?php /**PATH /home/nvdstor2/demo3.nvdstoreindonesia.com/system/resources/views////navbar.blade.php ENDPATH**/ ?>