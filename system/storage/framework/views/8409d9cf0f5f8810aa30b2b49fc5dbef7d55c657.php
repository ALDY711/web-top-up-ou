                ...
                <div class="shadow-detail-card px-3 pb-3 sm:py-8 md:px-6">
                    <div class="container relative flex flex-row items-center space-x-4 pb-3 md:items-center">
                        <div class="product-thumbnail-container -mt-8 sm:-mt-20 sm:rounded-3xl sm:bg-[#952624] sm:p-2 ">
                            <img width="300" height="300" src="<?php echo e($kategori->thumbnail); ?>" alt="<?php echo e($kategori->nama); ?>"
                        ...
                        <div class="flex-1 space-y-0.5 pt-6 sm:mt-3 sm:space-y-2 md:mt-6">
                            ...
                            <div class="flex flex-wrap items-center gap-2 gap-x-4 pt-3">
                                ...
                                <?php if($kategori->kode == "mobile-legends"||$kategori->kode == "free-fire" ||$kategori->kode == "mobile-legends-a" ||$kategori->kode == "genshin-impact" ||$kategori->kode == "pubg-mobile" ||$kategori->kode == "freefire-max"): ?>
                                    ...
                                    <span class="font-semibold">Instant</span></div>
                                     <?php elseif($kategori->kode == "Youtube-Premium" ||$kategori->kode == "Disney-Hotstar" || $kategori->kode == "Netflix-Premium" || $kategori->kode == "Spotify-Premium" || $kategori->kode == "Canva-Premium" || $kategori->kode == "Amazone-Prime-Premium"): ?>
                                    <div class="inline-flex items-center space-x-2 text-xs md:text-sm">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="h-3 w-3 text-yellow-400"><path d="M11.983 1.907a.75.75 0 00-1.292-.657l-8.5 9.5A.75.75 0 002.75 12h6.572l-1.305 6.093a.75.75 0 001.292.657l8.5-9.5A.75.75 0 0017.25 8h-6.572l1.305-6.093z"></path></svg>
                                                        ...
                                                        <div class="row">
                                                            <div class="col nominal-price text-white">
                                                                <?php if($nom->is_flash_sale == 1 && $nom->expired_flash_sale >= date('Y-m-d')): ?>
                                                                        ...
                                                                        <?php else: ?>
                                                                        <span class="sale-price text-white">Rp <?php echo e(number_format($nom->harga)); ?></span>
                                                                        <?php endif; ?>  
                                                            </div>
                                                        </div>
                                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tridisos/topup.tridisosmed.com/system/resources/views/components/order.blade.php ENDPATH**/ ?>