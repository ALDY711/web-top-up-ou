                        ...
                        <div class="px-1">
                            ...
                            <div class="card-body">
                                ...
                                <div id="userData">
                                    ...
                                    <p class="mt-2 text-sm" style="font-size: 12px; color: rgb(203, 203, 203);">Silahkan Masukkan User ID
                                   ...
                                   <?php elseif($kategori->kode == "ace-racer"): ?>
                                    ...
                                    <p class="mt-2 text-sm" style="font-size: 12px; color: rgb(203, 203, 203);">Silahkan Masukkan Nomor HP Anda. Contoh : 08xxxx</p>
                                   ...
                                   <?php elseif($kategori->kode == "Voucher-Shell"): ?>
                                    ...
                                    <?php elseif($kategori->tipe == "joki"): ?>
                                    <div>
                                        <div class="row row-cols row-cols-md">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <label for="email_joki"></label>
                                            ...
                                            <label for="<?php echo e($nom->id); ?>" class="list-group-item h-100 bg-gradient">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <div class="row">
                                                            <div class="col nominal-price text-white" href="#bayar">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mysticpe/job.mystic-pedia.net/system/resources/views/components/order.blade.php ENDPATH**/ ?>