            ...
            <div class="mb-3 row">
                ...
                <div class="col-lg-10">
                    <select class="form-select" name="provider">
                        ...
                        <option value="joki">Joki(Manual)</option>
                    </select>
                </div>
            </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-lg-10">
                        <input type="file" class="form-control" name="product_logo"> <?php $__errorArgs = ['product_logo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <hr />
                            <small class="mb-2 mt-2" style="color:red">*AKTIFKAN JIKA KAMU SEDANG MENGADAKAN FLASHSALE</small>
                            <div class="mb-3 row">
                                <label for="" class="col-lg-2 col-form-label">Harga Flashsale</label>
                                <div class="col-lg-5">
                                    <input type="number" class="form-control <?php $__errorArgs = ['harga_flash_salee'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('harga_flash_salee')); ?>" name="harga_flash_salee"> <?php $__errorArgs = ['harga_flash_salee'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 row">
                                <label for="" class="col-lg-1 col-form-label">Flash Sale?</label>
                                <div class="col-lg-5">
                                ...
                                <label for="" class="col-lg-1 col-form-label">Expired Date</label>
                                <div class="col-lg-5">
                                    <input type="date" class="form-control <?php $__errorArgs = ['expired_flash_sale'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('expired_flash_sale')); ?>" name="expired_flash_sale"> <?php $__errorArgs = ['expired_flash_sale'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback">
                    ...
                    <table class="table m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Rp. <font class="text-danger"><del><?php echo e(number_format($data->harga_flash_salee, 0, '.', ',')); ?></del></font></td>
                             <!--   <td>Rp. <?php echo e(number_format($data->harga_member, 0, '.', ',')); ?></td>
                                ...
                                <td><?php echo e($data->expired_flash_sale); ?></td>
                                <td>
...
<?php echo $__env->make('main-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mysticpe/fast21.my.id/demo6.fast21.my.id/system/resources/views/components/admin/layanan.blade.php ENDPATH**/ ?>