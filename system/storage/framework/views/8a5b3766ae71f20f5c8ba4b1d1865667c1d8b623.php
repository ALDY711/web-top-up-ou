...
<main class="min-h-[50vh]">
    ...
    <div class="mx-auto max-w-7xl px-4 md:px-8 lg:px-10 pt-2 md:pt-8 lg:pt-10 pb-16 flex flex-col gap-12 md:gap-16 lg:gap-20">
        <div class="flex flex-col">
            <h2 class="text-lg md:text-xl lg:text-2xl font-semibold leading-[26px] tracking-[0.2em] mb-8 text-center mt-4">Sejarah <?php echo e(config('app.name')); ?></h2>
                ...
                <div class="flex flex-col">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-3 md:gap-8 lg:gap-10 p-6 border-b border-[#626274]">
                        <p class="text-justify leading-7">
                            ...
                            dikenal sebagai <?php echo e(config('app.name')); ?> pada tahun 2019. <?php echo e(config('app.name')); ?> adalah Platform website top up game termurah, tercepat, dan terpercaya di Indonesia. Proses cepat membuat Anda nyaman Top Up disini. Dengan Menyediakan berbagai macam pembayaran Transfer Bank, E-Wallet, Scan QR, Alfamart, & Indomart dan pasti memudahkan anda untuk Top Up akun games kalian.
                        </p>
                        <p class="text-justify leading-7">
                            <?php echo e(config('app.name')); ?> memiliki jaringan kerja sama dengan berbagai publisher game, memudahkan pemain game untuk melakukan top up untuk game-game tersebut. Bisnis ini terus berkembang dan memperluas jangkauannya, dan pada
        ...
        <div class="flex flex-col">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-3 lg:gap-20">
                <div class="relative h-[460px] md:h-[480px] lg:h-[500px] w-full bg-gray-700 rounded-xl">
                    ...
                    >
                        <div>
                            <p class="text-[20px] md:text-[20px] lg:text-[20px] font-bold"><?php echo e(config('app.name')); ?> </p>
                            <p class="text-[15px] md:text-[15px] lg:text-[15px] font-medium">CEO</p>
                        </div>
                        <p class="text-[14px] md:text-[14px] lg:text-[14px] text-justify">mengawasi strategi dan pelaksanaan <?php echo e(config('app.name')); ?> agar perusahaan mencapai tujuan bisnisnya.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="flex flex-col">
            ...
            <div class="flex lg:flex-row md:flex-row flex-col gap-4 md:items-start lg:items-start">
                ...
                <p class="leading-7">
                    ...
                    <?php $__currentLoopData = $web_seting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <i class="fas fa-envelope " aria-hidden="true"></i> : <?php echo e($p->email_admin); ?><br>
                    <i class="fab fa-whatsapp"></i> : <?php echo e($p->wa_admin); ?><br>
                </p>
            </div>
...
<?php echo $__env->make('../main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mysticpe/fast21.my.id/demo6.fast21.my.id/system/resources/views/components/about-us.blade.php ENDPATH**/ ?>