...
height: 26px;
content: "";
background: url(/assets/thumbnail/verified.png) top/cover;
text-align: center;
}
...
.list-group-item:last-child {
    ...
    .area {
        ...
        --tw-gradient-from: rgb(50, 50, 62);
        --tw-gradient-to: rgba(30, 32, 34, 0);
        --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
        --tw-gradient-to: rgba(94, 102, 110, 0);
        --tw-gradient-stops: var(--tw-gradient-from), rgb(50, 50, 62), var(--tw-gradient-to);
        --tw-gradient-to: rgb(50, 50, 62);
        position: relative;
    }
                ...
                <div class="shadow-detail-card rounded-xl bg-nvd px-3 pb-3 sm:py-8 md:px-6">
                    <div class="relative flex flex-row items-center space-x-4 pb-3 md:items-center">
                        ...
                        <div class="flex-1 space-y-0.5 sm:mt-3 sm:space-y-2 md:mt-0">
                            ...
                            <h2>
                                <p class="text-sm text-gray-500"><small class="col-hp2  text-muted"><i
                                            class="far fa-clock" aria-hidden="true"></i> Open 24 Jam</small></p>
                            </h2>
                ...
                <div class="sticky top-24 flex flex-col space-y-8">
                    <div class="card">
                      <div class="flex border-b border-murky-900">
                        <div class="flex items-center justify-center rounded-tl-xl bg-gradient-to-b from-primary-400 to-primary-600 px-4 py-2 text-xl font-semibold">
                            <style>
                                .custom-icon {
                                    font-size: 12px;
                                }
                            </style>
                           <i class="fa fa-cart-arrow-down custom-icon" aria-hidden="true"></i>
                        </div>
...
<br>Cara Order :</br>
                                                ...
                                                <p style="margin-bottom: 10px; text-align: center;">
                                                    <font size="3" color="#ff9c00">
                                                        <span style="font-weight: bolder;">Top Up Buka 24 Jam</span>
                                                    </font>
                                                </p>
                                <p>
                        ...
                        <div class="px-1">
                            ...
                            <div class="card-body">
                                ...
                                <div id="userData">
                                        ...
                                        <div class="w-full">
                                            ...
                                            <div class="relative rounded-md text-black shadow-sm">
                                                ...
                                                <input
                                                    ...
                                                    name="ID ML" placeholder="User ID" type="text" value=""
                                                    id="user_id" />
                                    ...
                                    <p class="mt-2 text-sm" style="color: rgb(203, 203, 203);">Silahkan Masukkan User ID
                                    ...
                                    <div class="grid gap-2 grid-cols-2 sm:grid-cols-2 lg:grid-cols-2">
                                        ...
                                        <div class="w-full">
                                            ...
                                            <div class="relative rounded-md text-black shadow-sm">
                                                ...
                                                <input
                                                    class="block w-full rounded-full border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border-[#2D2EAD] focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]"
                                                    name="ID ML" placeholder="User ID" type="text" id="user_id" value=""
                                                    fdprocessedid="81xg1" />
                                   ...
                                   <div class="grid gap-2 grid-cols-2 sm:grid-cols-2 lg:grid-cols-2">
                                    ...
                                    <p class="mt-2 text-sm" style="color: rgb(203, 203, 203);">Silahkan Masukkan Nomor HP Anda. Contoh : 08xxxx</p>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-floating block w-full rounded-full border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border-[#2D2EAD] focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]" placeholder="Masukkan Email" type="text"
                                                name="ID ML" id="user_id" required>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group mb-3 text-black">
                                            ...
                                            <input class="form-floating block w-full rounded-full border-gray-300 text-sm shadow-sm sm:text-sm focus:outline-none focus:border-[#2D2EAD] focus:ring-2 focus:ring-[#2D2EAD] py-[0.5rem] px-[0.75rem]" placeholder="Masukkan Email +( Password Khusus Email Sendiri )" type="text"
                                                name="ID ML" id="user_id" required>
                                        ...
                                        <div class="row row-cols row-cols-md">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" placeholder="Masukkan Email/No HP"
                                                        type="text" name="Email" id="Email" required=""
                                                        fdprocessedid="z535rp" />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" placeholder="Minimal Request 3 Hero"
                                                        type="text" name="Request Hero" id="Request Hero" required=""
                                                        fdprocessedid="2z4c6r" />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" placeholder="User ID &amp; Nick Name"
                                                        type="text" name="Nick Name" id="Nick Name" required=""
                                                        fdprocessedid="hws6" />
                                    ...
                                    <?php elseif($kategori->kode == "joki-rank"): ?>
                                        ...
                                        <div class="row row-cols row-cols-md">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" placeholder="Masukkan ID" type="number"
                                                        name="User ID" id="User ID" required=""
                                                        fdprocessedid="m6aoo7" />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" placeholder="Masukkan Server"
                                                        type="number" name="Server ID" id="Server ID" required=""
                                                        fdprocessedid="4n5w1" />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" placeholder="Nick Name" type="text"
                                                        name="Nick Name" id="Nick Name" required=""
                                                        fdprocessedid="m8hoy7" />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" placeholder="Booking Tanggal Main"
                                                        type="text" name="Booking Tanggal Main"
                                                        id="Booking Tanggal Main" required="" fdprocessedid="irpsp" />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" placeholder="Booking Jam Main"
                                                        type="text" name="Booking Jam Main" id="Booking Jam Main"
                                                        required="" fdprocessedid="w6i9uc" />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control" placeholder="Catatan Untuk Penjoki"
                                                        type="text" name="Catatan Untuk Penjoki"
                                                        id="Catatan Untuk Penjoki" required="" fdprocessedid="vxxvn" />
                    ...
                    <div class="card border-0 mb-0 shadow-form">
                        <div class="px-4 py-1">
                            <div class="card-header d-flex align-items-center border-bottom pb-2">
                                ...
                                <h4 class="card-title mt-2 ms-2 lex items-center  font-extrabold leading-6 md:text-xl"
                                    style="color: rgb(234 234 234);">Pilih Nominal Top Up</h4>
                            </div>
                        </div>
                    </div>
                    <div class="px-1">
                                    ...
                                    <div class="area-list-payment-method">
                                        ...
                                        <div class="child-box payment-drawwer shadow">
                                            ...
                                            <div class="header short-payment-support-info-head"
                                                onclick="openPaymentDrawer(this)" style="background: rgb(50, 50, 62);">
                                                ...
                                                <div class="row p-1">
                                                    ...
                                                    <div class="col-lg-4 p-1">
                                                        ...
                                                        <div class="list-group1 h-100">
                                                            ...
                                                            <input type="radio" name="pembayaran" id="SALDO"
                                                                value="SALDO">
                                        ...
                                        <div class="child-box payment-drawwer">
                                            ...
                                            <div class="header short-payment-support-info-head"
                                                ...
                                                <div class="left">
                                                    ...
                                                    <b><i class="fas fa-credit-card" aria-hidden="true"></i> Transfer Bank</b>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-0 mr-3">
                                ...
                                <div class="g-recaptcha " id="g-recaptcha" name="grecaptcha"
                                    data-sitekey="<?php echo e(ENV('CAPTCHA_SITE_KEY')); ?>"></div>
               ...
               <button style="box-shadow: 0 .5rem 1rem rgba(255,255,255,.152)!important; background: rgb(184 15 15); color: rgb(255, 255, 255)"
                    ...
                    <div class="containerrrr">
                        <div class="flex justify-content-center">
                            ...
                            <span id="orderText" class="ms-2">Order Now</span>
                        </div>
                ...
                <div class="sticky inset-x-0 bottom-0 z-10 -mx-4 !mt-0 w-screen bg-murky-800 d-md-none"
    ...
    listGroupItems.forEach(function (item) {
        item.addEventListener('click', function () {
            ...
            var price = this.querySelector('.sale-price') ? this.querySelector('.sale-price')
                .textContent : this.querySelector('.text-white meltih').textContent;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nvdstor2/v2.nvdstoreindonesia.com/system/resources/views/components/order.blade.php ENDPATH**/ ?>