    ...
    <main class="relative">
        <div class="relative h-80 mt-4">
            <div class="absolute inset-0">
                <img class="hidden h-full w-full object-cover inline-block" src="<?php echo e($kategori->bannerlayanan); ?>"
                    alt="" />
            ...
            <div class="container relative flex flex-row items-center space-x-4 pb-3 md:items-center">
                ...
                <div class="flex-1 space-y-0.5 pt-6 sm:mt-3 sm:space-y-2 md:mt-6">
                    ...
                    <div class="flex flex-wrap items-center gap-2 gap-x-4 pt-3">
                        ...
                        <?php if($kategori->kode == "mobile-legends"||$kategori->kode == "free-fire" ||$kategori->kode ==
                        ...
                        <div class="row row-cols-2 mt-1">
                            ...
                            <div class="col-lg-4 px-2 mt-2">
                                <div class="list-group shadow h-100 ">
                                    <input type="radio" name="nominal" id="<?php echo e($nom->id); ?>" value="<?php echo e($nom->id); ?>"
                                        data-type="diamond">
                                    <label for="<?php echo e($nom->id); ?>" class="list-group-item h-100 bg-gradient">
                                        <div class="row">
                                            <div class="col">
                                                <div class="row" id="bayar">
                                                    <div class="col hayutopup-prod selected-order "><?php echo e($nom->layanan); ?>

                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col nominal-price text-white">
                                                        <?php if($nom->is_flash_sale == 1 && $nom->expired_flash_sale >=
                                                        date('Y-m-d')): ?>
                ...
                <div class="flex items-start justify-start space-x-4 py-1 md:hidden">
                    <div class="mb-2 aspect-square tihmel-5">
                        <img alt="icon" sizes="100vw" srcset="<?php echo e($kategori->thumbnail); ?>"
                            src="<?php echo e($kategori->thumbnail); ?>" width="300" height="300" decoding="async" data-nimg="1"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tridisos/topup.tridisosmed.com/system/resources/views/components/order_v2.blade.php ENDPATH**/ ?>