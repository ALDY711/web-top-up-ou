...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-lg-5">
                    <input type="text" class="form-control <?php $__errorArgs = ['harga_reseller'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('harga_reseller')); ?>" name="harga_reseller">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-lg-5">
                    <input type="text" class="form-control <?php $__errorArgs = ['harga_platinum'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                    ...
                    <table class="table m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Rp. <?php echo e(number_format($data->profit, 0, '.', ',')); ?></td>
                                <td>
...
<?php echo $__env->make('main-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nvdstor2/game.nvdstoreindonesia.com/system/resources/views/components/admin/layanan.blade.php ENDPATH**/ ?>