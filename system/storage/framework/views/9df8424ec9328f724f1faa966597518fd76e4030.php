    ...
    <div class="flex flex-1 items-center sm:items-center sm:justify-start ml-12 gap-4">
        <div class="flex flex-shrink-0 items-center">
            <a class="relative w-auto" href="<?php echo e(route('home')); ?>">
                <img alt="logo" srcset="<?php echo e(!$config ? '' : $config->web_logo); ?>" src="" width="50" height="50" decoding="async" data-nimg="1" class="block h-12 w-auto" loading="lazy" style="color: transparent;" />
            </a>
        </div>
       ...
       <div class="absolute right-0 mt-2 w-72 origin-top-right divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-non css-18exuzb transform opacity-0 scale-95 hidden" aria-labelledby="headlessui-menu-button-:R1qd6:" id="headlessui-menu-items-:r0:" role="menu" tabindex="0" data-headlessui-state="closed">
            ...
            <div class="px-1 py-1" role="none" id="headlessui-menu-item-:r1:" role="menuitem" tabindex="-1" data-headlessui-state="1">
                          ...
                          <?php endif; ?>
                      	  <?php if(auth()->guard()->check()): ?>
                      	 <?php if(Auth::user()->role !== "Admin"): ?>
                <a class="group flex w-full items-center rounded-md px-2 py-2 text-sm transition duration hover:bg-gray-50" id="headlessui-menu-item-:rf:" role="menuitem" tabindex="-1" data-headlessui-state="" href="<?php echo e(url('/user/dashboard')); ?>" ><i class="fas fa-home"></i>&nbsp;Dashboard</a>
                  <?php endif; ?>
                ...
                <div class="px-1 py-1" role="none"><style>
                    ...
                    <div id="headlessui-menu-item-:r1:" role="menuitem" tabindex="-1" data-headlessui-state="1">
                        <div class="text-center mt-4">
                            <img alt="mbgs-logo-" srcset="<?php echo e(!$config ? '' : $config->web_logo); ?>" src="<?php echo e(!$config ? '' : $config->web_logo); ?>" width="150" height="120" decoding="async" data-nimg="1" class="mx-auto" loading="lazy" style="color: transparent;"/>
...
.offcanvas-backdrop.show {
  ...
  backdrop-filter: blur(8px);
    ...
    <div class="flex shrink-0 items-center px-4">
        <div class="offcanvas offcanvas-start offcanvas-backdrop.show bg-gray-700" style="background: linear-gradient(to right, hsl(var(--bg-gradient-from)) 0%, hsl(var(--bg-gradient-via)) 50%, hsl(var(--bg-gradient-to))) 100% !important;" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel"  visibility: visible;" aria-modal="true" role="dialog">
            ...
            <img alt="logo" srcset="<?php echo e(!$config ? '' : $config->web_logo); ?>" src="<?php echo e(!$config ? '' : $config->web_logo); ?>" decoding="async" data-nimg="fill" loading="lazy" style="position: absolute;   inset: 0px; color: transparent;"/>
        </a>
     </div>
        <nav class="space-y-1 px-3 mt-4">
            <a class="group flex items-center rounded-md p-2 text-base font-medium css-1tq05rq hover:bg-btnPurple" href="<?php echo e(route('home')); ?>">
            ...
            <a class="group flex items-center rounded-md p-2 text-base font-medium css-1tq05rq hover:bg-btnPurple" href="<?php echo e(route('cari')); ?>">
                <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="mr-2" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    <desc></desc>
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item hover:bg-btnPurple" href="<?php echo e(route('hitungwr')); ?>">Winrate</a>
    <a class="dropdown-item hover:bg-btnPurple" href="<?php echo e(route('hitungpointmw')); ?>">Magic Wheel</a>
    <a class="dropdown-item hover:bg-btnPurple" href="<?php echo e(route('hitungpointzodiac')); ?>">Zodiac</a>
  </div>
</div>
           <div class="dropdown">
  <a class="group flex items-center rounded-md p-2 w-90 text-base font-medium css-1tq05rq dropdown-toggle hover:bg-btnPurple"  id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="cursor:pointer;">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <a class="dropdown-item hover:bg-btnPurple" href="<?php echo e(route('topten')); ?>">Top Ranking</a>
  </div>
</div>
</div>
...
<!-- End Show Navbar--><?php /**PATH /home/tridisos/topup.tridisosmed.com/system/resources/views////navbar.blade.php ENDPATH**/ ?>