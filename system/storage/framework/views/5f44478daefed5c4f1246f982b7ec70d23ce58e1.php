...
a {
  ...
  <!--Navbar -->
    <header class="mb-5">
    <nav class="fixed top-0 z-40 w-full bg-gray-300" data-headlessui-state="open" data-aos="fade-down">
    ...
    <div class="flex flex-1 items-center sm:items-center sm:justify-start ml-12 gap-4">
        <div class="flex flex-shrink-0 items-center">
            <a class="relative w-auto" href="<?php echo e(route('home')); ?>">
                <img alt="logo" srcset="<?php echo e(!$config ? '' : $config->web_logo); ?>" src="" width="50" height="50" decoding="async" data-nimg="1" class="block h-10 w-auto" loading="lazy" style="color: transparent;" />
            </a>
        </div>
...
<!-- End Show Navbar--><?php /**PATH /home/mysticpe/fast21.my.id/demo6.fast21.my.id/system/resources/views////navbar.blade.php ENDPATH**/ ?>