...
.creativeux-shadow {
    ...
    <body style="color: rgb(230, 230, 230);">
        <div class="w-full h-[100vh] absolute -z-10 lg:block md:block css-1jh570t">
            <img
                alt="bg-login"
                layout="responsive"
                sizes="100vw"
                srcset="/assets/image/irithl.jpg"
                src="/assets/image/irithl.jpg"
                decoding="async"
                data-nimg="fill"
                class="object-cover"
        ...
        <div class="w-full h-[100vh] absolute lg:block md:block z-[9] hidden">
            <img
                alt="bg-login-line"
                sizes="100vw"
                srcset="/assets/image/line-dash.webp"
                src="/_next/image?url=%2Fimages%2Fline-dash.png&amp;w=3840&amp;q=75"
                decoding="async"
                data-nimg="fill"
        ...
        <div class="justify-between pl-4 pr-2 md:px-12 lg:px-16 py-10 flex flex-col min-h-screen max-h-screen overflow-y-scroll overflow-x-hidden css-1jh570t">
           <a href="<?php echo e(route('home')); ?>">
            <img
                alt="logo"
                srcset="<?php echo e(isset($logoheader->path) ? $logoheader->path : ""); ?>"
                width="150"
                height="150"
                decoding="async"
                data-nimg="1"
            ...
            <div class="z-10">
                ...
                <div class="w-full md:w-1/2 lg:w-[35%] mt-[30px]">
                    ...
                    <form role="form" action="<?php echo e(route('post.login')); ?>" method="POST">
                        ...
                        <div class="relative mb-[20px] undefined">
                            <input
                                ...
                                class="block rounded-full creativeux-shadow pl-5 pr-5 false pb-2.5 pt-6 w-full text-sm border-0 appearance-none peer h-14 focus:duration-300 focus:outline-none undefined css-1y2p5dv"
                                placeholder=" "
                            />
                            <label
                        ...
                        <div class="relative mb-[20px] undefined">
                            <input
                                ...
                                class="block rounded-full creativeux-shadow pl-5 pr-5 pr-[3.2rem] pb-2.5 pt-6 w-full text-sm border-0 appearance-none peer h-14 focus:duration-300 focus:outline-none undefined css-1y2p5dv"
                                placeholder=" "
                        ...
                        <div class="g-recaptcha" id="g-recaptcha" name="grecaptcha" data-sitekey="<?php echo e(!$config ? '' : $config->captcha_sitekey); ?>"></div>
                        <button
                           type="submit" name="tombol" value="submit"
                            class="btn btn-primary mt-3 px-4 py-3 w-100 inline-flex w-full justify-center rounded-full text-sm font-semibold px-4 hover:scale-105 duration-300 items-center"
                    ...
                    <a class="inline-flex w-full py-3 px-4 justify-center text-sm font-semibold border rounded-full hover:scale-105 duration-300" href="<?php echo e(url('/register')); ?>" style="color: rgb(39, 39, 39); background: rgb(255, 255, 255);">
                        Daftar Sekarang
                    </a>
                </div>
            </div>
            <p class="mt-10 lg:text-start md:text-start text-center">© 2023 <?php echo e(!$config ? '' : $config->web_title); ?>. Semua Hak Cipta</p>
        </div>
    </body>
  ...
  function togglePasswordVisibility() {
    ...
    var passwordToggleIcon = document.querySelector(".password-toggle-icon svg");
  ...
  var passwordToggle = document.querySelector(".password-toggle-icon");
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mysticpe/fast21.my.id/demo6.fast21.my.id/system/resources/views/components/admin/login.blade.php ENDPATH**/ ?>