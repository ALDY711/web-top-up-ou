    ...
    <body style="color: rgb(230, 230, 230);">
        <div class="w-full h-[100vh] absolute -z-10 lg:block md:block hidden">
            <img
                ...
                layout="responsive"
                sizes="100vw"
                srcset="/assets/image/wp.jpg"
                src="/_next/image?url=%2Fimages%2Fbg-auth.png&amp;w=3840&amp;q=100"
                decoding="async"
                data-nimg="fill"
                class="object-cover"
        ...
        <div class="justify-between pl-4 pr-2 md:px-12 lg:px-16 py-10 flex flex-col min-h-screen max-h-screen overflow-y-scroll overflow-x-hidden css-1jh570t">
           <a href="<?php echo e(route('home')); ?>">
                ...
                <div class="w-full md:w-1/2 lg:w-[35%] mt-[30px]">
                    ...
                    <form role="form" action="<?php echo e(route('post.login')); ?>" method="POST">
                        ...
                        <div class="relative mb-[20px] undefined">
                            ...
                            <div>
                                <!--<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" class="w-5 h-5 absolute cursor-pointer top-[18px] right-6">-->
                                <!--    <path-->
            ...
            <p class="mt-10 lg:text-start md:text-start text-center">© 2023 <?php echo e(ENV('APP_NAME')); ?>. Semua Hak Cipta</p>
        </div>
    </body>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nvdstor2/v2.nvdstoreindonesia.com/system/resources/views/components/admin/login.blade.php ENDPATH**/ ?>