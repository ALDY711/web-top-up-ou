            ...
            <div class="col-lg-6">
                ...
                <h4 class="mb-3 header-title mt-0">&nbsp;</h4>
                   ...
                   <div class="mb-3 row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" value="<?php echo e($datas->tokopay_merchantid); ?>" name="ipaymu_va" disabled>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label class="col-lg-3 col-form-label" for="example-fileinput">Tokopay Secret Key</label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control" value="<?php echo e($datas->tokopay_secretkey); ?>" name="ipaymu_key" disabled>
                        </div>
                    </div>
                   <!-- <div class="mb-3 row">
                    ...
                    <div class='mb-3 row'>
                        ...
                        <div class='col-lg-9'>
                            <input type='text' class='form-control' value="<?php echo e($datas->warna_1); ?>" name='warna_1' disabled>
                        </div>
                    </div>
                    <div class='mb-3 row'>
                        <label class='col-lg-3 col-form-label' for='example-fileinput'>Warna Web #2</label>
                        <div class='col-lg-9'>
                            <input type='text' class='form-control' value="<?php echo e($datas->warna_2); ?>" name='warna_2' disabled>
                        </div>
                    </div>
                    <div class='mb-3 row'>
                        <label class='col-lg-3 col-form-label' for='example-fileinput'>Warna Web #3</label>
                        <div class='col-lg-9'>
                            <input type='text' class='form-control' value="<?php echo e($datas->warna_3); ?>" name='warna_3' disabled>
                        </div>
                    </div>
                    <div class='mb-3 row'>
                        <label class='col-lg-3 col-form-label' for='example-fileinput'>Warna Web #4</label>
                        <div class='col-lg-9'>
                            <input type='text' class='form-control' value="<?php echo e($datas->warna_4); ?>" name='warna_4' disabled>
                        </div>
                    </div>
...
<?php echo $__env->make('main-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tridisos/topup.tridisosmed.com/system/resources/views/components/admin/seting.blade.php ENDPATH**/ ?>