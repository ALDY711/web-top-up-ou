...
#searchContainer.visible {
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="<?php echo e(ENV('APP_WA')); ?>">Join Reseller</a>
    <a class="dropdown-item" href="<?php echo e(ENV('APP_TELE')); ?>">Join Komunitas</a>
  </div>
</div>
           <div class="dropdown">
  <a class="group flex items-center rounded-md p-2 w-90 text-base font-medium css-1tq05rq dropdown-toggle hover:bg-murky-700"  id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="cursor:pointer;">
...
<!-- End Show Navbar--><?php /**PATH /home/mysticpe/job.mystic-pedia.net/system/resources/views////navbar.blade.php ENDPATH**/ ?>