    ...
    <div class="card-body">
        <div class="row">
            <div class="col-lg-6">
                ...
                <h4 class="mb-3 header-title mt-0">Data</h4>
                    <?php echo csrf_field(); ?>
                    <div class="mb-3 row">
            ...
            <div class="col-lg-6">
                ...
                <h4 class="mb-3 header-title mt-0">&nbsp;</h4>
                    ...
                    <div class="mb-3 row">
                        <label class="col-lg-3 col-form-label" for="example-fileinput">Mystic CekID API ID</label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control" value="<?php echo e($datas->mystic_id); ?>" name="mystic_id" disabled>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label class="col-lg-3 col-form-label" for="example-fileinput">Mystic CekID API KEY</label>
                        <div class="col-lg-9">
                    ...
                    <div class="mb-3 row">
                        <label class="col-lg-3 col-form-label" for="example-fileinput">Fav Ico</label>
                        <div class="col-lg-9">
...
<?php echo $__env->make('main-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mysticpe/fast21.my.id/demo6.fast21.my.id/system/resources/views/components/admin/seting.blade.php ENDPATH**/ ?>